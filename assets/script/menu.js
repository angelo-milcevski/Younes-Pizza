                    ...
                    productsDiv.innerHTML +=
                        ...
                        <div class='orderBox' id="orderBox${category}${data[category][a].id}" style="display: none">
                            ...
                            <div class="extraBox" id="extraBox${category}${data[category][a].id}" style="overflow: auto;">                        
                                <input type="checkbox" name="hvidlog" value="0" class="extraCheck chkBox${category}${data[category][a].id}"><p class = "extraName">Hvidløg (0.00)</p>
                                ...
                                <input type="checkbox" name="tun" value="7" class="extraCheck chkBox${category}${data[category][a].id}"><p class = "extraName">Tun (7.00)</p>
                                <input type="checkbox" name="kylling" value="7" class="extraCheck chkBox${category}${data[category][a].id}"><p class = "extraName">Kylling (7.00)</p>
                                <input type="checkbox" name="fetaost" value="7" class="extraCheck chkBox${category}${data[category][a].id}"><p class = "extraName">Fetaost (7.00)</p>
                                ...
                                <input type="checkbox" name="cocktailpolser" value="7" class="extraCheck chkBox${category}${data[category][a].id}"><p class = "extraName">Cocktailpølser (7.00)</p>
                                <input type="checkbox" name="champignon" value="7" class="extraCheck chkBox${category}${data[category][a].id}"><p class = "extraName">Champignon (7.00)</p>
                                <input type="checkbox" name="majs" value="7" class="extraCheck chkBox${category}${data[category][a].id}"><p class = "extraName">Majs (7.00)</p>
                                <input type="checkbox" name="tomatskiver" value="7" class="extraCheck chkBox${category}${data[category][a].id}"><p class = "extraName">Tomatskiver (7.00)</p>
                                <input type="checkbox" name="skinke" value="7" class="extraCheck chkBox${category}${data[category][a].id}"><p class = "extraName">Skinke (7.00)</p>
                                <input type="checkbox" name="salat" value="7" class="extraCheck chkBox${category}${data[category][a].id}"><p class = "extraName">Salat (7.00)</p>
                                ...
                                <input type="checkbox" name="log" value="7" class="extraCheck chkBox${category}${data[category][a].id}"><p class = "extraName">Løg (7.00)</p>
                                <input type="checkbox" name="oksekod" value="7" class="extraCheck chkBox${category}${data[category][a].id}"><p class = "extraName">Oksekød (7.00)</p>
                                <input type="checkbox" name="kodsauce" value="7" class="extraCheck chkBox${category}${data[category][a].id}"><p class = "extraName">Kødsauce (7.00)</p>
                                ...
                                <input type="checkbox" name="creme_fraiche_dressing" value="7" class="extraCheck chkBox${category}${data[category][a].id}"><p class = "extraName">Creme fraiche dressing (7.00)</p>
                                ...
                                <input type="checkbox" name="muslinger" value="7" class="extraCheck chkBox${category}${data[category][a].id}"><p class = "extraName">Muslinger (7.00)</p>
                                <input type="checkbox" name="salat_og_dressing" value="7" class="extraCheck chkBox${category}${data[category][a].id}"><p class = "extraName">Salat og dressing (7.00)</p>
                                <input type="checkbox" name="rejer" value="7" class="extraCheck chkBox${category}${data[category][a].id}"><p class = "extraName">Rejer (7.00)</p>
                                <input type="checkbox" name="peberfrugt" value="7" class="extraCheck chkBox${category}${data[category][a].id}"><p class = "extraName">Peberfrugt (7.00)</p>
                                <input type="checkbox" name="ost" value="7" class="extraCheck chkBox${category}${data[category][a].id}"><p class = "extraName">Ost (7.00)</p>
                                <input type="checkbox" name="oliven" value="7" class="extraCheck chkBox${category}${data[category][a].id}"><p class = "extraName">Oliven (7.00)</p>
